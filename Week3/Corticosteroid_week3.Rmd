...
lines(ksrm.increase2[,2], col = 'red')
lines(ksrm.incerease5[,2], col = 'green')
lines(ksrm.decrease2[,2], col = 'blue')
lines(ksrm.decrease5[,2], col = "orange")

plot(ksrm.normal[,3] ~ ksrm.normal[,1], type = 'l',ylim = c(0, 300),
     xlab = "time", ylab = "free receptor", main = "R when ks.Rm is changed")
lines(ksrm.increase2[,3], col = 'red')
lines(ksrm.incerease5[,3], col = 'green')
lines(ksrm.decrease2[,3], col = 'blue')
lines(ksrm.decrease5[,3], col = "orange")


plot(ksrm.normal[,4] ~ ksrm.normal[,1], type = 'l',ylim = c(0, 50),
     xlab = "time", ylab = "DR concentration", main = "DR when ks.Rm is changed")
lines(ksrm.increase2[,4], col = 'red')
lines(ksrm.incerease5[,4], col = 'green')
lines(ksrm.decrease2[,4], col = 'blue')
lines(ksrm.decrease5[,4], col = "orange")


plot(ksrm.normal[,5] ~ ksrm.normal[,1], type = 'l',ylim = c(0, 50),
     xlab = "time", ylab = "DR(N) concentration", main = "R when ks.Rm is changed")
lines(ksrm.increase2[,5], col = 'red')
lines(ksrm.incerease5[,5], col = 'green')
lines(ksrm.decrease2[,5], col = 'blue')
lines(ksrm.decrease5[,5], col = "orange")
...
* mRNAr 
When looking at the mRNAr graph, the difference between using different mRNAr synthesis rates (ks.Rm) can be observed. As expected when looking at the line of the lower