...
```{r, echo=FALSE, fig.cap="\\textit{differential equations used by the model. Each differential equation is highlighted by different color; green represents demography paramters, orange represents infection parameters and purple represents movement paramters. Each equation calculates the population size of a different group. The groups are: susceptible animals in a pristine habitat ($S_P$), infected animals in a pristine habitat ($I_P$,) susceptible animals in a toxic contaminated habit ($S_T$) and infected aminals in a toxid contamindated area ($I_T$). Image obtained from Sánchez et al. (2020)}", out.width = '70%'}
...
```{r, echo=FALSE, fig.cap="\\textit{all of the paramters, definitoins, units and values used in the differential equations. The paramters are divided by demography, infection and movement. Image is obtained from Sánchez et al. (2020)} ", out.width = '70%'}
