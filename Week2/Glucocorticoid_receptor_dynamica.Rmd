...
At last, the DR(N) is probably the most import variable for the medicine to work. This is because the medicine need to get inside the nucleus in order to perform its function. When it is outside of the nucleus (inside the cytosol) it can not reach the genes and interact with it to influence the gene expression. 
